...
public class Util {
    ...
    static {
        ...
        // SubOption format: NAME IS/SEND (ASCII-DATA) IAC SE (Default)
        // 5 24 32


        // NAME (ASCII-DATA) IAC SE
        // 23
        //

        telnetOptions[0] = "TRANSMIT-BINARY"; telnetOptions[1] = "ECHO"; telnetOptions[2] = "RECONNECT";
        telnetOptions[3] = "SUPPRESS-GO-AHEAD"; telnetOptions[4] = "Approx-Message-Size-Negotiation";
        telnetOptions[5] = "STATUS";telnetOptions[6] = "TIMING-MARK";
        telnetOptions[7] = "RCTE[https://tools.ietf.org/html/rfc726]"; telnetOptions[8] = "Output-Line-Width";
        ...
        telnetOptions[18] = "LOGOUT"; telnetOptions[19] = "BM[https://tools.ietf.org/html/rfc735]";
        telnetOptions[20] = "DET[https://tools.ietf.org/html/rfc732]";telnetOptions[21] = "SUPDUP";
        telnetOptions[22] = "SUPDUP"; telnetOptions[23] = "SEND-LOCATION";telnetOptions[24] = "TERMINAL-TYPE";
        telnetOptions[25] = "END-OF-RECORD"; telnetOptions[26] = "TUID";
        telnetOptions[27] = "OUTMRK[https://tools.ietf.org/html/rfc933]"; telnetOptions[28] = "TTYLOC";
        telnetOptions[29] = "3270-REGIME";telnetOptions[30] = "X.3-PAD"; telnetOptions[31] = "NAWS";
        telnetOptions[32] = "TERMINAL-SPEED";telnetOptions[33] = "TOGGLE-FLOW-CONTROL";
        telnetOptions[34] = "LINEMODE[https://tools.ietf.org/html/rfc1184]"; telnetOptions[35] = "X-DISPLAY-LOCATION";
        telnetOptions[36] = "ENVIRON[https://tools.ietf.org/html/rfc1408]";
        telnetOptions[37] = "AUTHENTICATION[https://tools.ietf.org/html/rfc2941]";
        telnetOptions[38] = "ENCRYPT[https://tools.ietf.org/html/rfc2946]";
        telnetOptions[39] = "NEW-ENVIRON"; telnetOptions[40] = "TN3270E[https://tools.ietf.org/html/rfc2355]";
        telnetOptions[42] = "CHARSET[https://tools.ietf.org/html/rfc2066]";
        telnetOptions[44] = "COM-PORT-OPTION[https://tools.ietf.org/html/rfc2217]";telnetOptions[47] = "KERMIT";
        telnetOptions[255] = "EXTENDED-OPTIONS-LIST";
    ...
    public static String byteToDecString(byte input) {
        return String.format("%d ", input & 0xff);
    }
